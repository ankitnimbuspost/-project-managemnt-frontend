...
export default function Chatbox() {
    useEffect(() => {
        ...
        $('.dlab-chat-user-box .dlab-chat-user').on('click', openChatPage);
    ...
    const useScript = (src) => {
        ...
        }, [src]); // Ensure the effect runs when the src changes
    };
    //   useScript(`${process.env.PUBLIC_URL}/assets/js/custom.min.js`);
    return <>
        {/* Chat box start */}
        <div className="chatbox">
            ...
            <div className="custom-tab-1">
                <ul className="nav nav-tabs">
                    {/* <CancelRoundedIcon className="chatbox-close1" fontSize="large" style={{position:'absolute',left:"1%",'top':'0%',cursor:"pointer"}}></CancelRoundedIcon> */}
                        ...
                        <div className="card chat dlab-chat-history-box d-none">
                            <div className="card-header chat-list-header text-center">
                                ...
                                <div className="dropdown">
                                    <a href="javascript:void(0);" data-bs-toggle="dropdown" ariaExpanded="false">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlnsXlink="http://www.w3.org/1999/xlink"
                                            width="18px"
                            ...
                            <div className="card-body msg_card_body dlab-scroll" style={{ height: '400px', width: '300px', border: '1px solid #ddd',paddingRight:"0px",paddingTop:"revert-layer" }} id="DLAB_W_Contacts_Body3">
                                <PerfectScrollbar
                                    options={{
                                        wheelSpeed: 2,
                                        wheelPropagation: true,
                                ...
                                <div className="d-flex justify-content-end mb-4">
                                    ...
                                    <div className="img_cont_msg">
                                        <img src={`${process.env.PUBLIC_URL}/assets/images/avatar/2.jpg`} className="rounded-circle user_img_msg" alt="" />
                                    </div>
                                </div>
                                <div className="d-flex justify-content-start mb-4">
                                    <div className="img_cont_msg">
