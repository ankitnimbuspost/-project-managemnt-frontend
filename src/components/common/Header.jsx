...
export default function Header() {
    React.useEffect(()=>{
        ...
        $('.bell-link').on('click', handleChatbox);
        $('.chatbox-close').on('click', chatboxClose);
        // Cleanup event listener on unmount
        return () => {
          $('.bell-link').off('click', handleChatbox);
        };
                        ...
                        <ul className="navbar-nav header-right">
                            ...
                            <li className="nav-item dropdown notification_dropdown">
                                ...
                                <div className="dropdown-menu dropdown-menu-end">
                                    <div id="DZ_W_Notification1" className="widget-media dlab-scroll p-3" style={{ height: "380px" }}>
                                        <ul className="timeline">
                                            <li>
                                                <div className="timeline-panel">
                                                    <div className="media me-2">
                                                        <img alt="" style={{ width: "50px" }} src="assets/images/avatar/1.jpg" />
                                                    </div>
                                            ...
                                            <li>
                                                <div className="timeline-panel">
                                                    <div className="media me-2">
                                                        <img alt="" width="50" src="assets/images/avatar/1.jpg" />
                                                    </div>
                                                    <div className="media-body">
                                                        <h6 className="mb-1">Dr sultads Send you Photo</h6>
                                                        <small className="d-block">29 July 2020 - 02:26 PM</small>
                                    ...
                                    <Link className="all-notification" onClick={(e) => { e.preventDefault(); }}>See all notifications
                            ...
                            <li className="nav-item dropdown notification_dropdown">
                                <Link className="nav-link bell-link " to={"#"}>
                                    ...
                                    <span className="badge light text-white bg-secondary rounded-circle">1111</span>
                                </Link>
                            </li>
                            <li className="nav-item dropdown notification_dropdown">
                                <Link className="nav-link " onClick={(e) => { e.preventDefault(); }} data-bs-toggle="dropdown">
                                    <svg
                                        width="28"
                                        height="28"
                                        viewBox="0 0 28 28"
                                    ...
                                    <div id="DZ_W_TimeLine02" className="widget-timeline dlab-scroll style-1 ps ps--active-y p-3 height370">
                                        <ul className="timeline">
                                            <li>
                                                ...
                                                <Link className="timeline-panel text-muted" to={""} onClick={(e) => { e.preventDefault(); }}>
                                            ...
                                            <li>
                                                ...
                                                <Link className="timeline-panel text-muted" to={""} onClick={(e) => { e.preventDefault(); }}>
                                                    ...
                                                    <h6 className="mb-0">New order placed
                                            ...
                                            <li>
                                                ...
                                                <Link className="timeline-panel text-muted" onClick={(e) => { e.preventDefault(); }}>
                                                    <span>30 minutes ago</span>
                                                    <h6 className="mb-0">john just buy your product
